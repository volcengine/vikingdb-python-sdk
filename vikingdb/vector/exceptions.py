...
class VikingVectorException(Exception):
    ...
    def __init__(
        ...
        self.message = message or f"request failed with code={code!r}, request_id={self.request_id}"
...
class UnauthorizedException(VikingVectorException):
    """
...
class InvalidRequestException(VikingVectorException):
    """
...
class CollectionExistException(VikingVectorException):
    """
...
class CollectionNotExistException(VikingVectorException):
    """
...
class IndexExistException(VikingVectorException):
    """
...
class IndexNotExistException(VikingVectorException):
    """
...
class DataNotFoundException(VikingVectorException):
    """
...
class DelOpFailedException(VikingVectorException):
    """
...
class UpsertOpFailedException(VikingVectorException):
    """
...
class InvalidVectorException(VikingVectorException):
    """
...
class InvalidPrimaryKeyException(VikingVectorException):
    """
...
class InvalidFilterException(VikingVectorException):
    """
...
class IndexSearchException(VikingVectorException):
    """
...
class IndexFetchException(VikingVectorException):
    """
...
class IndexInitializingException(VikingVectorException):
    """
...
class EmbeddingException(VikingVectorException):
    """
...
class InternalServerException(VikingVectorException):
    """
...
class QuotaLimiterException(VikingVectorException):
    """
...
class CollectionAliasNotExistException(VikingVectorException):
    """
    Collection alias does not exist exception (Error code: 1000031)
    
    Triggered by:
    - Provided collection alias is incorrect or missing
    
    Resolution:
    - Verify the collection alias spelling and configuration
    """
    pass


class ServiceNotPurchasedException(VikingVectorException):
    """
    Service not purchased exception (Error code: 1000032)
    
    Triggered by:
    - Requesting vector database service in a region without an active order
    
    Resolution:
    - Purchase and activate the vector database service in the requested region
    """
    pass


class PaymentOverdueException(VikingVectorException):
    """
    Payment overdue exception (Error code: 1000033)
    
    Triggered by:
    - Account has overdue payments for the vector database service
    
    Resolution:
    - Recharge the account and clear outstanding balance
    """
    pass

class OfflineTaskNotExistException(VikingVectorException):
    """
    Offline task does not exist exception (Error code: 1000035)
    
    Triggered by:
    - Offline task ID is incorrect or corresponds to a deleted task
    
    Resolution:
    - Verify the offline task ID or recreate the offline task
    """
    pass
...
EXCEPTION_MAP = {
    ...
    1000031: CollectionAliasNotExistException, # Collection alias does not exist
    1000032: ServiceNotPurchasedException,    # Service not purchased in region
    1000033: PaymentOverdueException,         # Account payment overdue
    1000035: OfflineTaskNotExistException,    # Offline task does not exist
}
